...
#warning important, read, maybe even do, later
// @discussion
// we might actually want to merge request and response classes
// so the competion block of request would return request and NSError
// request and response classes are tightly coupled anyways
// but we should keep response as a property of request object
